...
describe('ProductListComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [ProductListComponent, MockComponent(ProductCardComponent)],
      providers: [
  ...
  it('should load products by category when filtering by product category', fakeAsync(() => {
    // Given
    component.products = [];
    component.filterFormGroup.patchValue({ category: ProductCategory.FOOD });
  ...
  it('should load all products when category field is reset', fakeAsync(() => {
    // Given
    component.products = [];
    component.filterFormGroup.patchValue({ category: null });
